...
export interface Screen {
    ...
    setTextColors(game: Game, windowId: number, foreground: Color, background: Color): void
...
export class ScreenBase implements Screen {
    ...
    setOutputWindow(game: Game, windowId: number) {
        this.log.debug(`not implemented: ${this.id} setOutputWindow windowId=${windowId}`);
    }
    ...
    clearWindow(game: Game, windowId: number) {
        this.log.debug(`not implemented: ${this.id} clearWindow windowId=${windowId}`);
    }
    ...
    setCursorPosition(_game: Game, line: number, column: number, windowId: number) {
        this.log.debug(`not implemented: ${this.id} setCursorPosition line=${line} column=${column} windowId=${windowId}`);
    }

    hideCursor(_game: Game, windowId: number) {
        this.log.debug(`not implemented: ${this.id} hideCursor windowId=${windowId}`);
    }

    showCursor(_game: Game, windowId: number) {
        this.log.debug(`not implemented: ${this.id} showCursor windowId=${windowId}`);
    }
    ...
    setTextColors(game: Game, windowId: number, foreground: Color, background: Color) {
        this.log.debug(`not implemented: ${this.id} setTextColors windowId=${windowId} foreground=${foreground} background=${background}`);
    }

    enableOutputStream(_game: Game, streamId: number, table: number, width: number) {
        this.log.debug(`not implemented: ${this.id} enableOutputStream streamId=${streamId} table=${table} width=${width}`);
    }

    disableOutputStream(_game: Game, streamId: number, table: number, width: number) {
        this.log.debug(`not implemented: ${this.id} disableOutputStream streamId=${streamId} table=${table} width=${width}`);
    }

    selectInputStream(_game: Game, streamId: number) {
        this.log.debug(`not implemented: ${this.id} selectInputStream streamId=${streamId}`);
    }
